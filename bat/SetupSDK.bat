...
:: Path to Flex SDK
set FLEX_SDK=C:\Users\FeilanHome\AppData\Local\FlashDevelop\Apps\ascsdk\18.0.0
::set FLEX_SDK=C:\Users\Feilan\AppData\Local\FlashDevelop\Apps\ascsdk\18.0.0
set AUTO_INSTALL_IOS=yes

:: Path to Android SDK
set ANDROID_SDK=C:\Program Files (x86)\FlashDevelop\Tools\android
::set ANDROID_SDK=C:\dev\FlashDevelop\Tools\android
