...
:: Android packaging
set AND_CERT_NAME="Logicle"
set AND_CERT_PASS=n2c9s8b5_jsb
set AND_CERT_FILE=cert\Logicle.p12
...
set IOS_PROVISION=cert\Logicle.mobileprovision
...
set APP_ID=com.rampantmuffin.Logicle

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Logicle
